        ...
        >
            ...
            collectables
              ...
              .map((collectable) => (
                <StyledImage
                  ...
                  x={parseFloat(collectable.coords[0]) - 15 / 2}
                  y={parseFloat(collectable.coords[1]) - 15 / 2}
                  width={15}
                  height={15}
                  onClick={() => {
                    setSelectedItem(collectable, itemTypes.COLLECTABLES);
                  }}
                  onTouchEnd={() => {
                    setSelectedItem(collectable, itemTypes.COLLECTABLES);
                  }}
          ...
          {settings.spawns.state &&
            spawns.map((spawn) => (
              <StyledCircle
                key={
                  spawn.zone + spawn.area + spawn.coords[0] + spawn.coords[1]
                }
              ...
              .map((animal) => {
                return (
                  <StyledImage
                    ...
                    height={25}
                    onClick={() => {
                      setSelectedItem(animal, itemTypes.ANIMALS);
                    }}
                    onTouchEnd={() => {
                      setSelectedItem(animal, itemTypes.ANIMALS);
                    }}
          ...
          {settings.boxes.state &&
            boxes.map((box) =>
              settings.numbers.state ? (
                <StyledText
                  key={box.area + box.zone + box.coords[0] + box.coords[1]}
